...
newContactInfo.set({
    ...
    render(){
       ...
       <div id="webviewleftmancontainer" className="col-lg-6" style={{backgroundColor:"#add8e6"}}>
       <div className="row">
      ...
      <div id="extrasmalllogo" className="row" style={{backgroundColor:"white"}}>
       <img src={group}  id="optionalstuffs" alt="home img" style={{width:'50%',height:'50%',paddingLeft:"5%",padding:"5%"}}/>  
      </div>
